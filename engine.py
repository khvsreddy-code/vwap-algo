    ...
    def _run_socket(self):
        ...
        while self.running and not self.market_data_blocked:
            ...
            try:
                ...
                # If the SDK returns normally, its keep_running loop has ended.
                # Do not mark this as a fatal error; the controlled outer loop
                # immediately creates a fresh socket.
