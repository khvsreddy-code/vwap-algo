...
def _within_entry_window(timestamp):
...
class TradingEngine:
    ...
    def _accept_closed_live_candle(self, candle):
        ...
        if signal:
            ...
            if _within_entry_window(signal_time):
                ...
                try:
                    ...
                    pass
                self._log("ENTRY BLOCKED • outside 09:15–15:15 IST entry window.", "info")
