...
-- Server-side Streamlit recorder permissions. The app uses the Supabase secret key.
...
grant select, insert, update, delete on table public.market_candles_1m to service_role;
