"""V10 regression tests for conservative regime filtering and multi-cycle VWAP entries."""
import pandas as pd
from strategy import VwapConfirmationEngine, StrategyConfig

def test_regime_filter_does_not_impose_daily_trade_quota():
    cfg = StrategyConfig(15, 8, v10_quality_mode=True)
...
if __name__ == "__main__":
    ...
    print("V10 regression tests passed")


def test_chart_module_uses_stable_component_key_and_incremental_payload():
    from pathlib import Path
    source = Path(__file__).with_name("v10_live_chart.py").read_text()
