...
class FyersClient:
    ...
    def start_data_socket(
        ...
        # Use the SDK's native reconnect lifecycle.  Do not pass a finite
        # reconnect_retry value: on Streamlit Cloud that can leave the socket
        # permanently cycling between "ended" and "connecting" after a transient
