...
def make_payload(df, vwap=True, ltp=None, levels=None, markers=None, title="", height=620):
...
def render(df, title, height=620, vwap=True, ltp=None, levels=None, markers=None):
    ...
    if _component is None:
        ...
        return
    _component(data=payload, key=f"live-{title}-{height}")
