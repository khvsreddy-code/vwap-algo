...
def make_payload(df, vwap=True, ltp=None, levels=None, markers=None, title="", height=900):
...
def render(df, title, height=900, vwap=True, ltp=None, levels=None, markers=None):
