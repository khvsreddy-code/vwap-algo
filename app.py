...
if engine:
    ...
    live_ok = bool(engine.running and engine.ws_connected and tick)
    if tick:
        age = (pd.Timestamp.now(tz="Asia/Kolkata") - pd.Timestamp(tick["time"])).total_seconds()
        live_ok = live_ok and age < 8
