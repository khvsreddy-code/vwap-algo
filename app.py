...
def _render_data_center():
    ...
    if live_engine is not None:
        ...
        c2.metric("Tracked options", len(getattr(live_engine, "cloud_data_symbols", set())))
    ...
    scope = st.selectbox("Data", ["Everything", "NIFTY 50", "20 CE", "20 PE"], key="cloud_data_scope")
    ...
    if st.button("↻ Load cloud data", type="primary", width="stretch", key="load_cloud_data"):
        try:
