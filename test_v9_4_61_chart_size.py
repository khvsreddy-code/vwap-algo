...
def test_chart_sizes_from_streamlit_mount_host():
    assert "const mountHost = root && root.host instanceof HTMLElement ? root.host : root;" in CHART
...
def test_chart_is_registered_as_v9_4_61():
    assert 'name="fyers_vwap_live_chart_v9_4_61"' in CHART
